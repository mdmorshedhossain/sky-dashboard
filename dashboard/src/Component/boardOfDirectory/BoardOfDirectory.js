...
const BoardOfDirectory = () => {
    ...
    const deleteImage = (id) =>{
        ...
        fetch(`http://localhost:5000/deleteBoardOfDirectors/${id}`, {
            method: "DELETE",
            headers: {
            ...
            {/*Add new events modal */}
            {
                    ...
                    <div className='flex flex-col'>
                        <form
                            ...
                            action='http://localhost:5000/addBoardOfDirectors'
                            method='post'
                            encType='multipart/form-data'
                        >
                            <div>
                                <input name='name' className='w-full rounded-sm px-2 text-sm h-8' type="text" placeholder='Name' /> <br />
                                <input name='title' className='w-full mt-2 rounded-sm px-2 text-sm h-8' type="text" placeholder='Title' /> <br />
                                <input
                                className='mt-2'  
                                type="file" 
                                name="addBoardOfDirectors"/>
                                <button 
             ...
             {/*Edit image modal */}
             {
                ...
                <div style={{zIndex:'12', background:'#f2eded'}} className='rounded flex flex-col justify-center items-center border absolute h-[300px] w-[700px] top-[120px] right-[230px] shadow-lg'>
                    <div>
                        ...
                        <form
                            // onSubmit={insertImage}
                            action='http://localhost:5000/editBoardOfDirectors'
                            method='post'
                            encType='multipart/form-data'
                        >
                            <div>
