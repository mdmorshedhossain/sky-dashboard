...
const UpcommingEvents = () => {
    ...
    const deleteImage = (id) =>{
        ...
        fetch(`http://localhost:5000/upcomingevents/${id}`, {
            method: "DELETE",
            headers: {
            ...
            {/*Add new events modal */}
            {
                    ...
                    <div className='flex flex-col'>
                        <form
                            ...
                            action='http://localhost:5000/addUpcomingEvents'
                            method='post'
                            encType='multipart/form-data'
                        >
                            <div>
                                <input name='title' className='w-full rounded-sm px-2 text-sm h-8' type="text" placeholder='Title' /> <br />
                                <input name='date' className='w-full mt-2 rounded-sm px-2 text-sm h-8' type="text" placeholder='Date' /> <br />
                                <textarea name='details' className='mt-2 w-full rounded-sm px-2 text-sm' id="" cols="30" rows="2" placeholder='Descriptions'></textarea> <br />
                                <input
                                className='mt-2'  
                                type="file" 
                                name="addUpcomingEvents"/>
                                <button 
             ...
             {/*Edit image modal */}
             {
                ...
                <div style={{zIndex:'12', background:'#f2eded'}} className='rounded flex flex-col justify-center items-center border absolute h-[300px] w-[700px] top-[120px] right-[230px] shadow-lg'>
                    <div>
                        ...
                        <form
                            // onSubmit={insertImage}
                            action='http://localhost:5000/editUpcomingEvent'
                            method='post'
                            encType='multipart/form-data'
                        >
                            <div>
