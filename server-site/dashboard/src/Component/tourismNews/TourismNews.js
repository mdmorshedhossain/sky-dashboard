...
const TourismNews = () => {
    ...
    const deleteImage = (id) =>{
        ...
        fetch(`http://localhost:5000/deleteTourismNews/${id}`, {
            method: "DELETE",
            headers: {
                ...
                {/*Add new events modal */}
                {
                    ...
                    <div className='flex flex-col'>
                        <form
                            ...
                            action='http://localhost:5000/addTourismNews'
                            method='post'
             ...
             {/*Edit image modal */}
             {
                ...
                <div style={{zIndex:'12', background:'#f2eded'}} className='rounded flex flex-col justify-center items-center border absolute h-[300px] w-[700px] top-[120px] right-[230px] shadow-lg'>
                    <div>
                        ...
                        <form
                            // onSubmit={insertImage}
                            action='http://localhost:5000/editTourismNews'
                            method='post'
                            encType='multipart/form-data'
                        >
                            <div>
